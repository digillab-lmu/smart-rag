...
[![Version 0.3.0](https://img.shields.io/badge/version-0.3.0-green)](CHANGELOG.md)
...
cd /srv/smart-rag
git checkout v0.3.0                         # the current release
...
Version 0.3.0. Below 1.0: interfaces and stored formats may still change
between releases.
