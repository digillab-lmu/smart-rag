...
declare -A MSG_EN=(
    ...
    [admin_cfg_reranker]="Reranker API key (switching provider needs a docker-compose.yml edit, not covered here)"
...
declare -A MSG_DE=(
    ...
    [admin_cfg_reranker]="Reranker-API-Key (Anbieter wechseln braucht einen docker-compose.yml-Edit, hier nicht abgedeckt)"
    [admin_cfg_lms]="LMS-URL"
